...
import com.informatica.vds.custom.sources.ifxcdc.InformixCDCSource;
...
public class SourceTest {
	...
	public static void main(String args[]) {
		...
		try {
			...
			writer.flush();
			testsrc = new InformixCDCSource(true, writer);
...
//			String optarg;
			...
			Getopt g = new Getopt(_progname, args, "c:u:p:o:", longopts);
